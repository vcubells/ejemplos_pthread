//
//  main.c
//  3.2.22_pthread_mutexattr_setprioceiling
//
...
int main(int argc, char **argv)
{
    ...
    // Modificar el atributo PRIOCEILING
    pthread_mutexattr_setprioceiling(&mutexattr, 10);
    
    // Inicializar dinámicamente el mutex
    pthread_mutex_init(&mutex, &mutexattr);
    
    // Obtener el valor del atributo PRIOCEILING con que se crea el mutex
    pthread_mutexattr_getprioceiling(&mutexattr, &prioceiling);
    
    printf("Mutex creado con PRIOCEILING = %d \n", prioceiling);
